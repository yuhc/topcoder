...
public:
	vector <string> decode(string message) {
		int k, len = message.length();
		
		//P[0]==0
		string s1 = "0";
		for (int i = 0; i < len - 1; i++) {
			if (i == 0) k = int(message[i] - s1[i]);
			else k = int(message[i] + '0' - s1[i] - s1[i-1]);
			if (k != 0 && k != 1) {
				s1 = "NONE";
				break;
			}
		...
		if (int(s1[len-1] - '0' + s1[len-2] - '0') != int(message[len-1] - '0'))
			s1 = "NONE";

		//P[0]==1
		string s2 = "1";
		for (int i = 0; i < len - 1; i++) {
			if (i == 0) k = int(message[i] - s2[i]);
			else k = int(message[i] + '0' - s2[i] - s2[i-1]);
			if (k != 0 && k != 1) {
				s2 = "NONE";
				break;
			}
		...
		if (int(s2[len-1] - '0' + s2[len-2] - '0') != int(message[len-1] - '0'))
			s2 = "NONE";
